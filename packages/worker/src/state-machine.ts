...
/** Job types that bypass transition gating (e.g. monitoring jobs that don't change bot status). */
export const BYPASS_TRANSITION_JOBS: ReadonlySet<string> = new Set(["HEALTH_POLL"]);
